...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-10-2023 a las 13:53:22
...
(500, 'RNB/LS 7748', 'Bryan Martinez', 'papi', '7863602816', '1345 NW 98TH CT', 'UNIT 2', 'Miami', 'Florida', '33172', 'Estados Unidos', 12, 12.00);
...
--
ALTER TABLE `customers`
  MODIFY `customerNumber` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=501;
COMMIT;
